...
INSERT INTO public.tb_goods (goods_no, merchant_sn, goods_nm, goods_amt, goods_qtt, frst_regist_dt)
	VALUES(nextval('goods_seq'), 2, '청바지1', 300, 100, now());
INSERT INTO public.tb_goods (goods_no, merchant_sn, goods_nm, goods_amt, goods_qtt, frst_regist_dt)
	VALUES(nextval('goods_seq'), 2, '자켓1', 300, 150, now());
INSERT INTO public.tb_goods (goods_no, merchant_sn, goods_nm, goods_amt, goods_qtt, frst_regist_dt)
	VALUES(nextval('goods_seq'), 2, '양말1', 100, 50, now());
INSERT INTO public.tb_goods (goods_no, merchant_sn, goods_nm, goods_amt, goods_qtt, frst_regist_dt)
	VALUES(nextval('goods_seq'), 2, '티셔츠1', 200, 200, now());
-- * sn3 삼성 가맹점
INSERT INTO public.tb_goods (goods_no, merchant_sn, goods_nm, goods_amt, goods_qtt, frst_regist_dt)
	VALUES(nextval('goods_seq'), 3, '갤럭시S', 100, 200, now());
INSERT INTO public.tb_goods (goods_no, merchant_sn, goods_nm, goods_amt, goods_qtt, frst_regist_dt)
	VALUES(nextval('goods_seq'), 3, '갤럭시노트22', 100, 200, now());
INSERT INTO public.tb_goods (goods_no, merchant_sn, goods_nm, goods_amt, goods_qtt, frst_regist_dt)
	VALUES(nextval('goods_seq'), 3, '갤럭시Z플립', 200, 250, now());
-- * sn5 유니클로 가맹점
INSERT INTO public.tb_goods (goods_no, merchant_sn, goods_nm, goods_amt, goods_qtt, frst_regist_dt)
	VALUES(nextval('goods_seq'), 4, '후리스', 300, 500, now());
INSERT INTO public.tb_goods (goods_no, merchant_sn, goods_nm, goods_amt, goods_qtt, frst_regist_dt)
	VALUES(nextval('goods_seq'), 4, '스웨터1', 300, 220, now());
INSERT INTO public.tb_goods (goods_no, merchant_sn, goods_nm, goods_amt, goods_qtt, frst_regist_dt)
	VALUES(nextval('goods_seq'), 4, '바지1', 200, 200, now());
INSERT INTO public.tb_goods (goods_no, merchant_sn, goods_nm, goods_amt, goods_qtt, frst_regist_dt)
	VALUES(nextval('goods_seq'), 4, '양말1', 100, 500, now());
